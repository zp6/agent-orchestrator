...
| **operator action required** | Register GitHub App for Marketplace listing. Set up Polar.sh billing page. Submit to GitHub Marketplace. Set env var `FLEET_POLAR_URL`. |
